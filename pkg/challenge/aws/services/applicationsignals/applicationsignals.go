...
func (Discovery) CloudJamType() string { return "AWS::ApplicationSignals::Discovery" }
...
func (GroupingConfiguration) CloudJamType() string {
...
func (ServiceLevelObjective) CloudJamType() string {
