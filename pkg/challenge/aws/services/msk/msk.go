...
func (BatchScramSecret) CloudJamType() string { return "AWS::MSK::BatchScramSecret" }
...
func (Channel) CloudJamType() string { return "AWS::MSK::Channel" }
...
func (Cluster) CloudJamType() string { return "AWS::MSK::Cluster" }
...
func (ClusterPolicy) CloudJamType() string { return "AWS::MSK::ClusterPolicy" }
...
func (Configuration) CloudJamType() string { return "AWS::MSK::Configuration" }
...
func (Replicator) CloudJamType() string { return "AWS::MSK::Replicator" }
...
func (ServerlessCluster) CloudJamType() string { return "AWS::MSK::ServerlessCluster" }
...
func (Topic) CloudJamType() string { return "AWS::MSK::Topic" }
...
func (VpcConnection) CloudJamType() string { return "AWS::MSK::VpcConnection" }
