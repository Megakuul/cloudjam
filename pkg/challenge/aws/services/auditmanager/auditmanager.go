...
func (Assessment) CloudJamType() string { return "AWS::AuditManager::Assessment" }
...
func (AssessmentFramework) CloudJamType() string { return "AWS::AuditManager::AssessmentFramework" }
