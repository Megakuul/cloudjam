...
func (Application) CloudJamType() string { return "AWS::AppIntegrations::Application" }
...
func (DataIntegration) CloudJamType() string { return "AWS::AppIntegrations::DataIntegration" }
...
func (EventIntegration) CloudJamType() string { return "AWS::AppIntegrations::EventIntegration" }
