...
func (IdMappingWorkflow) CloudJamType() string { return "AWS::EntityResolution::IdMappingWorkflow" }
...
func (IdNamespace) CloudJamType() string { return "AWS::EntityResolution::IdNamespace" }
...
func (MatchingWorkflow) CloudJamType() string { return "AWS::EntityResolution::MatchingWorkflow" }
...
func (PolicyStatement) CloudJamType() string { return "AWS::EntityResolution::PolicyStatement" }
...
func (SchemaMapping) CloudJamType() string { return "AWS::EntityResolution::SchemaMapping" }
