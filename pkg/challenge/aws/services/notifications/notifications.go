...
func (ChannelAssociation) CloudJamType() string { return "AWS::Notifications::ChannelAssociation" }
...
func (EventRule) CloudJamType() string { return "AWS::Notifications::EventRule" }
...
func (ManagedNotificationAccountContactAssociation) CloudJamType() string {
...
func (ManagedNotificationAdditionalChannelAssociation) CloudJamType() string {
...
func (NotificationConfiguration) CloudJamType() string {
...
func (NotificationHub) CloudJamType() string { return "AWS::Notifications::NotificationHub" }
...
func (OrganizationalUnitAssociation) CloudJamType() string {
