...
func (AccessPoint) CloudJamType() string { return "AWS::S3Files::AccessPoint" }
...
func (FileSystem) CloudJamType() string { return "AWS::S3Files::FileSystem" }
...
func (FileSystemPolicy) CloudJamType() string { return "AWS::S3Files::FileSystemPolicy" }
...
func (MountTarget) CloudJamType() string { return "AWS::S3Files::MountTarget" }
