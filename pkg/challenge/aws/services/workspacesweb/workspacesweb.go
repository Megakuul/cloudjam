...
func (BrowserSettings) CloudJamType() string { return "AWS::WorkSpacesWeb::BrowserSettings" }
...
func (DataProtectionSettings) CloudJamType() string {
...
func (IdentityProvider) CloudJamType() string { return "AWS::WorkSpacesWeb::IdentityProvider" }
...
func (IpAccessSettings) CloudJamType() string { return "AWS::WorkSpacesWeb::IpAccessSettings" }
...
func (NetworkSettings) CloudJamType() string { return "AWS::WorkSpacesWeb::NetworkSettings" }
...
func (Portal) CloudJamType() string { return "AWS::WorkSpacesWeb::Portal" }
...
func (SessionLogger) CloudJamType() string { return "AWS::WorkSpacesWeb::SessionLogger" }
...
func (TrustStore) CloudJamType() string { return "AWS::WorkSpacesWeb::TrustStore" }
...
func (UserAccessLoggingSettings) CloudJamType() string {
...
func (UserSettings) CloudJamType() string { return "AWS::WorkSpacesWeb::UserSettings" }
