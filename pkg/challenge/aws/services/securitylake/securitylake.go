...
func (AwsLogSource) CloudJamType() string { return "AWS::SecurityLake::AwsLogSource" }
...
func (DataLake) CloudJamType() string { return "AWS::SecurityLake::DataLake" }
...
func (Subscriber) CloudJamType() string { return "AWS::SecurityLake::Subscriber" }
...
func (SubscriberNotification) CloudJamType() string {
