...
func (ComponentVersion) CloudJamType() string { return "AWS::GreengrassV2::ComponentVersion" }
...
func (Deployment) CloudJamType() string { return "AWS::GreengrassV2::Deployment" }
