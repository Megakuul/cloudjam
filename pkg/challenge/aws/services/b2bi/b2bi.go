...
func (Capability) CloudJamType() string { return "AWS::B2BI::Capability" }
...
func (Partnership) CloudJamType() string { return "AWS::B2BI::Partnership" }
...
func (Profile) CloudJamType() string { return "AWS::B2BI::Profile" }
...
func (Transformer) CloudJamType() string { return "AWS::B2BI::Transformer" }
