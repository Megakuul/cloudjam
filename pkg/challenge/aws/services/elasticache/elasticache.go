...
func (CacheCluster) CloudJamType() string { return "AWS::ElastiCache::CacheCluster" }
...
func (GlobalReplicationGroup) CloudJamType() string {
...
func (ParameterGroup) CloudJamType() string { return "AWS::ElastiCache::ParameterGroup" }
...
func (ReplicationGroup) CloudJamType() string { return "AWS::ElastiCache::ReplicationGroup" }
...
func (SecurityGroup) CloudJamType() string { return "AWS::ElastiCache::SecurityGroup" }
...
func (SecurityGroupIngress) CloudJamType() string { return "AWS::ElastiCache::SecurityGroupIngress" }
...
func (ServerlessCache) CloudJamType() string { return "AWS::ElastiCache::ServerlessCache" }
...
func (SubnetGroup) CloudJamType() string { return "AWS::ElastiCache::SubnetGroup" }
...
func (User) CloudJamType() string { return "AWS::ElastiCache::User" }
...
func (UserGroup) CloudJamType() string { return "AWS::ElastiCache::UserGroup" }
