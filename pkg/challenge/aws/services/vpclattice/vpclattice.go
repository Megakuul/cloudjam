...
func (AccessLogSubscription) CloudJamType() string { return "AWS::VpcLattice::AccessLogSubscription" }
...
func (AuthPolicy) CloudJamType() string { return "AWS::VpcLattice::AuthPolicy" }
...
func (DomainVerification) CloudJamType() string { return "AWS::VpcLattice::DomainVerification" }
...
func (Listener) CloudJamType() string { return "AWS::VpcLattice::Listener" }
...
func (ResourceConfiguration) CloudJamType() string { return "AWS::VpcLattice::ResourceConfiguration" }
...
func (ResourceGateway) CloudJamType() string { return "AWS::VpcLattice::ResourceGateway" }
...
func (ResourcePolicy) CloudJamType() string { return "AWS::VpcLattice::ResourcePolicy" }
...
func (Rule) CloudJamType() string { return "AWS::VpcLattice::Rule" }
...
func (Service) CloudJamType() string { return "AWS::VpcLattice::Service" }
...
func (ServiceNetwork) CloudJamType() string { return "AWS::VpcLattice::ServiceNetwork" }
...
func (ServiceNetworkResourceAssociation) CloudJamType() string {
...
func (ServiceNetworkServiceAssociation) CloudJamType() string {
...
func (ServiceNetworkVpcAssociation) CloudJamType() string {
...
func (TargetGroup) CloudJamType() string { return "AWS::VpcLattice::TargetGroup" }
