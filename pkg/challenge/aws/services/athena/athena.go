...
func (CapacityReservation) CloudJamType() string { return "AWS::Athena::CapacityReservation" }
...
func (DataCatalog) CloudJamType() string { return "AWS::Athena::DataCatalog" }
...
func (NamedQuery) CloudJamType() string { return "AWS::Athena::NamedQuery" }
...
func (PreparedStatement) CloudJamType() string { return "AWS::Athena::PreparedStatement" }
...
func (WorkGroup) CloudJamType() string { return "AWS::Athena::WorkGroup" }
