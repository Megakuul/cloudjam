...
func (App) CloudJamType() string { return "AWS::Amplify::App" }
...
func (Branch) CloudJamType() string { return "AWS::Amplify::Branch" }
...
func (Domain) CloudJamType() string { return "AWS::Amplify::Domain" }
