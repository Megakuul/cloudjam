...
func (Campaign) CloudJamType() string { return "AWS::IoTFleetWise::Campaign" }
...
func (DecoderManifest) CloudJamType() string { return "AWS::IoTFleetWise::DecoderManifest" }
...
func (Fleet) CloudJamType() string { return "AWS::IoTFleetWise::Fleet" }
...
func (ModelManifest) CloudJamType() string { return "AWS::IoTFleetWise::ModelManifest" }
...
func (SignalCatalog) CloudJamType() string { return "AWS::IoTFleetWise::SignalCatalog" }
...
func (StateTemplate) CloudJamType() string { return "AWS::IoTFleetWise::StateTemplate" }
...
func (Vehicle) CloudJamType() string { return "AWS::IoTFleetWise::Vehicle" }
