...
func (Config) CloudJamType() string { return "AWS::GroundStation::Config" }
...
func (DataflowEndpointGroup) CloudJamType() string {
...
func (DataflowEndpointGroupV2) CloudJamType() string {
...
func (MissionProfile) CloudJamType() string { return "AWS::GroundStation::MissionProfile" }
