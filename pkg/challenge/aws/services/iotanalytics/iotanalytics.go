...
func (Channel) CloudJamType() string { return "AWS::IoTAnalytics::Channel" }
...
func (Dataset) CloudJamType() string { return "AWS::IoTAnalytics::Dataset" }
...
func (Datastore) CloudJamType() string { return "AWS::IoTAnalytics::Datastore" }
...
func (Pipeline) CloudJamType() string { return "AWS::IoTAnalytics::Pipeline" }
