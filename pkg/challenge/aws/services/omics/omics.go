...
func (AnnotationStore) CloudJamType() string { return "AWS::Omics::AnnotationStore" }
...
func (Configuration) CloudJamType() string { return "AWS::Omics::Configuration" }
...
func (ReferenceStore) CloudJamType() string { return "AWS::Omics::ReferenceStore" }
...
func (RunGroup) CloudJamType() string { return "AWS::Omics::RunGroup" }
...
func (SequenceStore) CloudJamType() string { return "AWS::Omics::SequenceStore" }
...
func (VariantStore) CloudJamType() string { return "AWS::Omics::VariantStore" }
...
func (Workflow) CloudJamType() string { return "AWS::Omics::Workflow" }
...
func (WorkflowVersion) CloudJamType() string { return "AWS::Omics::WorkflowVersion" }
