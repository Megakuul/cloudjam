...
func (DRTAccess) CloudJamType() string { return "AWS::Shield::DRTAccess" }
...
func (ProactiveEngagement) CloudJamType() string { return "AWS::Shield::ProactiveEngagement" }
...
func (Protection) CloudJamType() string { return "AWS::Shield::Protection" }
...
func (ProtectionGroup) CloudJamType() string { return "AWS::Shield::ProtectionGroup" }
