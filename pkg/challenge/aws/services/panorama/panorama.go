...
func (ApplicationInstance) CloudJamType() string { return "AWS::Panorama::ApplicationInstance" }
...
func (Package) CloudJamType() string { return "AWS::Panorama::Package" }
...
func (PackageVersion) CloudJamType() string { return "AWS::Panorama::PackageVersion" }
