...
func (ReplicationSet) CloudJamType() string { return "AWS::SSMIncidents::ReplicationSet" }
...
func (ResponsePlan) CloudJamType() string { return "AWS::SSMIncidents::ResponsePlan" }
