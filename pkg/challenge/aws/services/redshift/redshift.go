...
func (Cluster) CloudJamType() string { return "AWS::Redshift::Cluster" }
...
func (ClusterParameterGroup) CloudJamType() string { return "AWS::Redshift::ClusterParameterGroup" }
...
func (ClusterSecurityGroup) CloudJamType() string { return "AWS::Redshift::ClusterSecurityGroup" }
...
func (ClusterSecurityGroupIngress) CloudJamType() string {
...
func (ClusterSubnetGroup) CloudJamType() string { return "AWS::Redshift::ClusterSubnetGroup" }
...
func (EndpointAccess) CloudJamType() string { return "AWS::Redshift::EndpointAccess" }
...
func (EndpointAuthorization) CloudJamType() string { return "AWS::Redshift::EndpointAuthorization" }
...
func (EventSubscription) CloudJamType() string { return "AWS::Redshift::EventSubscription" }
...
func (Integration) CloudJamType() string { return "AWS::Redshift::Integration" }
...
func (ScheduledAction) CloudJamType() string { return "AWS::Redshift::ScheduledAction" }
...
func (SnapshotSchedule) CloudJamType() string { return "AWS::Redshift::SnapshotSchedule" }
