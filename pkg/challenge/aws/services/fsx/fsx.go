...
func (DataRepositoryAssociation) CloudJamType() string { return "AWS::FSx::DataRepositoryAssociation" }
...
func (FileSystem) CloudJamType() string { return "AWS::FSx::FileSystem" }
...
func (S3AccessPointAttachment) CloudJamType() string { return "AWS::FSx::S3AccessPointAttachment" }
...
func (Snapshot) CloudJamType() string { return "AWS::FSx::Snapshot" }
...
func (StorageVirtualMachine) CloudJamType() string { return "AWS::FSx::StorageVirtualMachine" }
...
func (Volume) CloudJamType() string { return "AWS::FSx::Volume" }
