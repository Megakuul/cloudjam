...
func (Application) CloudJamType() string { return "AWS::KinesisAnalytics::Application" }
...
func (ApplicationOutput) CloudJamType() string { return "AWS::KinesisAnalytics::ApplicationOutput" }
