...
func (ConnectAttachment) CloudJamType() string { return "AWS::NetworkManager::ConnectAttachment" }
...
func (ConnectPeer) CloudJamType() string { return "AWS::NetworkManager::ConnectPeer" }
...
func (CoreNetwork) CloudJamType() string { return "AWS::NetworkManager::CoreNetwork" }
...
func (CoreNetworkPrefixListAssociation) CloudJamType() string {
...
func (CustomerGatewayAssociation) CloudJamType() string {
...
func (Device) CloudJamType() string { return "AWS::NetworkManager::Device" }
...
func (DirectConnectGatewayAttachment) CloudJamType() string {
...
func (GlobalNetwork) CloudJamType() string { return "AWS::NetworkManager::GlobalNetwork" }
...
func (Link) CloudJamType() string { return "AWS::NetworkManager::Link" }
...
func (LinkAssociation) CloudJamType() string { return "AWS::NetworkManager::LinkAssociation" }
...
func (Site) CloudJamType() string { return "AWS::NetworkManager::Site" }
...
func (SiteToSiteVpnAttachment) CloudJamType() string {
...
func (TransitGatewayPeering) CloudJamType() string {
...
func (TransitGatewayRegistration) CloudJamType() string {
...
func (TransitGatewayRouteTableAttachment) CloudJamType() string {
...
func (VpcAttachment) CloudJamType() string { return "AWS::NetworkManager::VpcAttachment" }
