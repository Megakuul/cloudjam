...
func (ResourcePolicy) CloudJamType() string { return "AWS::Kinesis::ResourcePolicy" }
...
func (Stream) CloudJamType() string { return "AWS::Kinesis::Stream" }
...
func (StreamConsumer) CloudJamType() string { return "AWS::Kinesis::StreamConsumer" }
