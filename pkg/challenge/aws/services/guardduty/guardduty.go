...
func (Detector) CloudJamType() string { return "AWS::GuardDuty::Detector" }
...
func (Filter) CloudJamType() string { return "AWS::GuardDuty::Filter" }
...
func (IPSet) CloudJamType() string { return "AWS::GuardDuty::IPSet" }
...
func (MalwareProtectionPlan) CloudJamType() string { return "AWS::GuardDuty::MalwareProtectionPlan" }
...
func (Master) CloudJamType() string { return "AWS::GuardDuty::Master" }
...
func (Member) CloudJamType() string { return "AWS::GuardDuty::Member" }
...
func (PublishingDestination) CloudJamType() string { return "AWS::GuardDuty::PublishingDestination" }
...
func (ThreatEntitySet) CloudJamType() string { return "AWS::GuardDuty::ThreatEntitySet" }
...
func (ThreatIntelSet) CloudJamType() string { return "AWS::GuardDuty::ThreatIntelSet" }
...
func (TrustedEntitySet) CloudJamType() string { return "AWS::GuardDuty::TrustedEntitySet" }
