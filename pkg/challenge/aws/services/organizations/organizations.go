...
func (Account) CloudJamType() string { return "AWS::Organizations::Account" }
...
func (Organization) CloudJamType() string { return "AWS::Organizations::Organization" }
...
func (OrganizationalUnit) CloudJamType() string { return "AWS::Organizations::OrganizationalUnit" }
...
func (Policy) CloudJamType() string { return "AWS::Organizations::Policy" }
...
func (ResourcePolicy) CloudJamType() string { return "AWS::Organizations::ResourcePolicy" }
