...
func (Blueprint) CloudJamType() string { return "AWS::Glue::Blueprint" }
...
func (Catalog) CloudJamType() string { return "AWS::Glue::Catalog" }
...
func (Classifier) CloudJamType() string { return "AWS::Glue::Classifier" }
...
func (Connection) CloudJamType() string { return "AWS::Glue::Connection" }
...
func (Crawler) CloudJamType() string { return "AWS::Glue::Crawler" }
...
func (CustomEntityType) CloudJamType() string { return "AWS::Glue::CustomEntityType" }
...
func (DataCatalogEncryptionSettings) CloudJamType() string {
...
func (DataQualityRuleset) CloudJamType() string { return "AWS::Glue::DataQualityRuleset" }
...
func (Database) CloudJamType() string { return "AWS::Glue::Database" }
...
func (DevEndpoint) CloudJamType() string { return "AWS::Glue::DevEndpoint" }
...
func (IdentityCenterConfiguration) CloudJamType() string {
...
func (Integration) CloudJamType() string { return "AWS::Glue::Integration" }
...
func (IntegrationResourceProperty) CloudJamType() string {
...
func (Job) CloudJamType() string { return "AWS::Glue::Job" }
...
func (MLTransform) CloudJamType() string { return "AWS::Glue::MLTransform" }
...
func (Partition) CloudJamType() string { return "AWS::Glue::Partition" }
...
func (Registry) CloudJamType() string { return "AWS::Glue::Registry" }
...
func (Schema) CloudJamType() string { return "AWS::Glue::Schema" }
...
func (SchemaVersionSchemaVersion) CloudJamType() string { return "AWS::Glue::SchemaVersion" }
...
func (SchemaVersionMetadata) CloudJamType() string { return "AWS::Glue::SchemaVersionMetadata" }
...
func (SecurityConfiguration) CloudJamType() string { return "AWS::Glue::SecurityConfiguration" }
...
func (Table) CloudJamType() string { return "AWS::Glue::Table" }
...
func (TableOptimizer) CloudJamType() string { return "AWS::Glue::TableOptimizer" }
...
func (Trigger) CloudJamType() string { return "AWS::Glue::Trigger" }
...
func (UsageProfile) CloudJamType() string { return "AWS::Glue::UsageProfile" }
...
func (UserDefinedFunction) CloudJamType() string { return "AWS::Glue::UserDefinedFunction" }
...
func (Workflow) CloudJamType() string { return "AWS::Glue::Workflow" }
