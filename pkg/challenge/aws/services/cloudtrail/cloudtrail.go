...
func (Channel) CloudJamType() string { return "AWS::CloudTrail::Channel" }
...
func (Dashboard) CloudJamType() string { return "AWS::CloudTrail::Dashboard" }
...
func (EventDataStore) CloudJamType() string { return "AWS::CloudTrail::EventDataStore" }
...
func (ResourcePolicy) CloudJamType() string { return "AWS::CloudTrail::ResourcePolicy" }
...
func (Trail) CloudJamType() string { return "AWS::CloudTrail::Trail" }
