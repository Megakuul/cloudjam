...
func (LogAnomalyDetectionIntegration) CloudJamType() string {
...
func (NotificationChannel) CloudJamType() string { return "AWS::DevOpsGuru::NotificationChannel" }
...
func (ResourceCollection) CloudJamType() string { return "AWS::DevOpsGuru::ResourceCollection" }
