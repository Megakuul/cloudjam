...
func (ConfigurationSet) CloudJamType() string { return "AWS::SMSVOICE::ConfigurationSet" }
...
func (OptOutList) CloudJamType() string { return "AWS::SMSVOICE::OptOutList" }
...
func (PhoneNumber) CloudJamType() string { return "AWS::SMSVOICE::PhoneNumber" }
...
func (Pool) CloudJamType() string { return "AWS::SMSVOICE::Pool" }
...
func (ProtectConfiguration) CloudJamType() string { return "AWS::SMSVOICE::ProtectConfiguration" }
...
func (Registration) CloudJamType() string { return "AWS::SMSVOICE::Registration" }
...
func (ResourcePolicy) CloudJamType() string { return "AWS::SMSVOICE::ResourcePolicy" }
...
func (SenderId) CloudJamType() string { return "AWS::SMSVOICE::SenderId" }
