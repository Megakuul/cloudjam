...
func (ConfigurationSet) CloudJamType() string { return "AWS::SES::ConfigurationSet" }
...
func (ConfigurationSetEventDestination) CloudJamType() string {
...
func (ContactList) CloudJamType() string { return "AWS::SES::ContactList" }
...
func (CustomVerificationEmailTemplate) CloudJamType() string {
...
func (DedicatedIpPool) CloudJamType() string { return "AWS::SES::DedicatedIpPool" }
...
func (EmailIdentity) CloudJamType() string { return "AWS::SES::EmailIdentity" }
...
func (MailManagerAddonInstance) CloudJamType() string { return "AWS::SES::MailManagerAddonInstance" }
...
func (MailManagerAddonSubscription) CloudJamType() string {
...
func (MailManagerAddressList) CloudJamType() string { return "AWS::SES::MailManagerAddressList" }
...
func (MailManagerArchive) CloudJamType() string { return "AWS::SES::MailManagerArchive" }
...
func (MailManagerIngressPoint) CloudJamType() string { return "AWS::SES::MailManagerIngressPoint" }
...
func (MailManagerRelay) CloudJamType() string { return "AWS::SES::MailManagerRelay" }
...
func (MailManagerRuleSet) CloudJamType() string { return "AWS::SES::MailManagerRuleSet" }
...
func (MailManagerTrafficPolicy) CloudJamType() string { return "AWS::SES::MailManagerTrafficPolicy" }
...
func (MultiRegionEndpoint) CloudJamType() string { return "AWS::SES::MultiRegionEndpoint" }
...
func (ReceiptFilter) CloudJamType() string { return "AWS::SES::ReceiptFilter" }
...
func (ReceiptRule) CloudJamType() string { return "AWS::SES::ReceiptRule" }
...
func (ReceiptRuleSet) CloudJamType() string { return "AWS::SES::ReceiptRuleSet" }
...
func (Template) CloudJamType() string { return "AWS::SES::Template" }
...
func (Tenant) CloudJamType() string { return "AWS::SES::Tenant" }
...
func (VdmAttributes) CloudJamType() string { return "AWS::SES::VdmAttributes" }
