...
func (Component) CloudJamType() string { return "AWS::ImageBuilder::Component" }
...
func (ContainerRecipe) CloudJamType() string { return "AWS::ImageBuilder::ContainerRecipe" }
...
func (DistributionConfiguration) CloudJamType() string {
...
func (Image) CloudJamType() string { return "AWS::ImageBuilder::Image" }
...
func (ImagePipeline) CloudJamType() string { return "AWS::ImageBuilder::ImagePipeline" }
...
func (ImageRecipe) CloudJamType() string { return "AWS::ImageBuilder::ImageRecipe" }
...
func (InfrastructureConfiguration) CloudJamType() string {
...
func (LifecyclePolicy) CloudJamType() string { return "AWS::ImageBuilder::LifecyclePolicy" }
...
func (Workflow) CloudJamType() string { return "AWS::ImageBuilder::Workflow" }
