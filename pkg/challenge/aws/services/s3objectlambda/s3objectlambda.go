...
func (AccessPoint) CloudJamType() string { return "AWS::S3ObjectLambda::AccessPoint" }
...
func (AccessPointPolicy) CloudJamType() string { return "AWS::S3ObjectLambda::AccessPointPolicy" }
