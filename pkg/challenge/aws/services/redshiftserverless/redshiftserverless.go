...
func (Namespace) CloudJamType() string { return "AWS::RedshiftServerless::Namespace" }
...
func (Snapshot) CloudJamType() string { return "AWS::RedshiftServerless::Snapshot" }
...
func (Workgroup) CloudJamType() string { return "AWS::RedshiftServerless::Workgroup" }
