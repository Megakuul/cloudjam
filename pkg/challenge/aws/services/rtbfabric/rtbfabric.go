...
func (InboundExternalLink) CloudJamType() string { return "AWS::RTBFabric::InboundExternalLink" }
...
func (Link) CloudJamType() string { return "AWS::RTBFabric::Link" }
...
func (LinkRoutingRule) CloudJamType() string { return "AWS::RTBFabric::LinkRoutingRule" }
...
func (OutboundExternalLink) CloudJamType() string { return "AWS::RTBFabric::OutboundExternalLink" }
...
func (RequesterGateway) CloudJamType() string { return "AWS::RTBFabric::RequesterGateway" }
...
func (ResponderGateway) CloudJamType() string { return "AWS::RTBFabric::ResponderGateway" }
