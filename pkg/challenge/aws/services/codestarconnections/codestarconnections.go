...
func (Connection) CloudJamType() string { return "AWS::CodeStarConnections::Connection" }
...
func (RepositoryLink) CloudJamType() string { return "AWS::CodeStarConnections::RepositoryLink" }
...
func (SyncConfiguration) CloudJamType() string { return "AWS::CodeStarConnections::SyncConfiguration" }
