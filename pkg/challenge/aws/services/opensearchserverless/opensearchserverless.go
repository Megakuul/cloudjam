...
func (AccessPolicy) CloudJamType() string { return "AWS::OpenSearchServerless::AccessPolicy" }
...
func (Collection) CloudJamType() string { return "AWS::OpenSearchServerless::Collection" }
...
func (CollectionGroup) CloudJamType() string { return "AWS::OpenSearchServerless::CollectionGroup" }
...
func (CollectionIndex) CloudJamType() string { return "AWS::OpenSearchServerless::CollectionIndex" }
...
func (Index) CloudJamType() string { return "AWS::OpenSearchServerless::Index" }
...
func (LifecyclePolicy) CloudJamType() string { return "AWS::OpenSearchServerless::LifecyclePolicy" }
...
func (SecurityConfig) CloudJamType() string { return "AWS::OpenSearchServerless::SecurityConfig" }
...
func (SecurityPolicy) CloudJamType() string { return "AWS::OpenSearchServerless::SecurityPolicy" }
...
func (VpcEndpoint) CloudJamType() string { return "AWS::OpenSearchServerless::VpcEndpoint" }
