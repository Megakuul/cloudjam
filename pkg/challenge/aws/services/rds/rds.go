...
func (CustomDBEngineVersion) CloudJamType() string { return "AWS::RDS::CustomDBEngineVersion" }
...
func (DBCluster) CloudJamType() string { return "AWS::RDS::DBCluster" }
...
func (DBClusterParameterGroup) CloudJamType() string { return "AWS::RDS::DBClusterParameterGroup" }
...
func (DBInstance) CloudJamType() string { return "AWS::RDS::DBInstance" }
...
func (DBParameterGroup) CloudJamType() string { return "AWS::RDS::DBParameterGroup" }
...
func (DBProxy) CloudJamType() string { return "AWS::RDS::DBProxy" }
...
func (DBProxyEndpoint) CloudJamType() string { return "AWS::RDS::DBProxyEndpoint" }
...
func (DBProxyTargetGroup) CloudJamType() string { return "AWS::RDS::DBProxyTargetGroup" }
...
func (DBSecurityGroup) CloudJamType() string { return "AWS::RDS::DBSecurityGroup" }
...
func (DBSecurityGroupIngress) CloudJamType() string { return "AWS::RDS::DBSecurityGroupIngress" }
...
func (DBShardGroup) CloudJamType() string { return "AWS::RDS::DBShardGroup" }
...
func (DBSubnetGroup) CloudJamType() string { return "AWS::RDS::DBSubnetGroup" }
...
func (EventSubscription) CloudJamType() string { return "AWS::RDS::EventSubscription" }
...
func (GlobalCluster) CloudJamType() string { return "AWS::RDS::GlobalCluster" }
...
func (Integration) CloudJamType() string { return "AWS::RDS::Integration" }
...
func (OptionGroup) CloudJamType() string { return "AWS::RDS::OptionGroup" }
