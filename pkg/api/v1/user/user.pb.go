...
const file_v1_user_user_proto_rawDesc = "" +
	"\n" +
	"\x12v1/user/user.proto\x12\av1.user\"\xf8\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"max_streak\x18\t \x01(\x03R\tmaxStreakB)Z'github.com/megakuul/zen/pkg/api/v1/userb\x06proto3"
...
var file_v1_user_user_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
