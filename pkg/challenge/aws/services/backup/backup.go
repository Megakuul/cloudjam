...
func (BackupPlan) CloudJamType() string { return "AWS::Backup::BackupPlan" }
...
func (BackupSelection) CloudJamType() string { return "AWS::Backup::BackupSelection" }
...
func (BackupVault) CloudJamType() string { return "AWS::Backup::BackupVault" }
...
func (Framework) CloudJamType() string { return "AWS::Backup::Framework" }
...
func (LegalHold) CloudJamType() string { return "AWS::Backup::LegalHold" }
...
func (LogicallyAirGappedBackupVault) CloudJamType() string {
...
func (ReportPlan) CloudJamType() string { return "AWS::Backup::ReportPlan" }
...
func (RestoreTestingPlan) CloudJamType() string { return "AWS::Backup::RestoreTestingPlan" }
...
func (RestoreTestingSelection) CloudJamType() string { return "AWS::Backup::RestoreTestingSelection" }
...
func (TieringConfiguration) CloudJamType() string { return "AWS::Backup::TieringConfiguration" }
