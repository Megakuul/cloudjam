...
func (Agent) CloudJamType() string { return "AWS::Bedrock::Agent" }
...
func (AgentAlias) CloudJamType() string { return "AWS::Bedrock::AgentAlias" }
...
func (ApplicationInferenceProfile) CloudJamType() string {
...
func (AutomatedReasoningPolicy) CloudJamType() string {
...
func (AutomatedReasoningPolicyVersion) CloudJamType() string {
...
func (Blueprint) CloudJamType() string { return "AWS::Bedrock::Blueprint" }
...
func (DataAutomationLibrary) CloudJamType() string { return "AWS::Bedrock::DataAutomationLibrary" }
...
func (DataAutomationProject) CloudJamType() string { return "AWS::Bedrock::DataAutomationProject" }
...
func (DataSource) CloudJamType() string { return "AWS::Bedrock::DataSource" }
...
func (EnforcedGuardrailConfiguration) CloudJamType() string {
...
func (Flow) CloudJamType() string { return "AWS::Bedrock::Flow" }
...
func (FlowAlias) CloudJamType() string { return "AWS::Bedrock::FlowAlias" }
...
func (FlowVersion) CloudJamType() string { return "AWS::Bedrock::FlowVersion" }
...
func (Guardrail) CloudJamType() string { return "AWS::Bedrock::Guardrail" }
...
func (GuardrailVersion) CloudJamType() string { return "AWS::Bedrock::GuardrailVersion" }
...
func (IntelligentPromptRouter) CloudJamType() string { return "AWS::Bedrock::IntelligentPromptRouter" }
...
func (KnowledgeBase) CloudJamType() string { return "AWS::Bedrock::KnowledgeBase" }
...
func (KnowledgeBasePolicy) CloudJamType() string { return "AWS::Bedrock::KnowledgeBasePolicy" }
...
func (Prompt) CloudJamType() string { return "AWS::Bedrock::Prompt" }
...
func (PromptVersion) CloudJamType() string { return "AWS::Bedrock::PromptVersion" }
...
func (ResourcePolicy) CloudJamType() string { return "AWS::Bedrock::ResourcePolicy" }
