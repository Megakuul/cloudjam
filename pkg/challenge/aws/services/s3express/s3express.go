...
func (AccessPoint) CloudJamType() string { return "AWS::S3Express::AccessPoint" }
...
func (BucketPolicy) CloudJamType() string { return "AWS::S3Express::BucketPolicy" }
...
func (DirectoryBucket) CloudJamType() string { return "AWS::S3Express::DirectoryBucket" }
