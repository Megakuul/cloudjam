...
func (CustomResource) CloudJamType() string { return "AWS::CloudFormation::CustomResource" }
...
func (GeneratedTemplate) CloudJamType() string { return "AWS::CloudFormation::GeneratedTemplate" }
...
func (GuardHook) CloudJamType() string { return "AWS::CloudFormation::GuardHook" }
...
func (HookDefaultVersion) CloudJamType() string { return "AWS::CloudFormation::HookDefaultVersion" }
...
func (HookTypeConfig) CloudJamType() string { return "AWS::CloudFormation::HookTypeConfig" }
...
func (HookVersion) CloudJamType() string { return "AWS::CloudFormation::HookVersion" }
...
func (LambdaHook) CloudJamType() string { return "AWS::CloudFormation::LambdaHook" }
...
func (Macro) CloudJamType() string { return "AWS::CloudFormation::Macro" }
...
func (ModuleDefaultVersion) CloudJamType() string { return "AWS::CloudFormation::ModuleDefaultVersion" }
...
func (ModuleVersion) CloudJamType() string { return "AWS::CloudFormation::ModuleVersion" }
...
func (PublicTypeVersion) CloudJamType() string { return "AWS::CloudFormation::PublicTypeVersion" }
...
func (Publisher) CloudJamType() string { return "AWS::CloudFormation::Publisher" }
...
func (ResourceDefaultVersion) CloudJamType() string {
...
func (ResourceVersion) CloudJamType() string { return "AWS::CloudFormation::ResourceVersion" }
...
func (Stack) CloudJamType() string { return "AWS::CloudFormation::Stack" }
...
func (StackSet) CloudJamType() string { return "AWS::CloudFormation::StackSet" }
...
func (TypeActivation) CloudJamType() string { return "AWS::CloudFormation::TypeActivation" }
...
func (WaitCondition) CloudJamType() string { return "AWS::CloudFormation::WaitCondition" }

type WaitConditionHandle struct {
	Id *string `json:"Id,omitempty"`
}

func (WaitConditionHandle) CloudJamType() string { return "AWS::CloudFormation::WaitConditionHandle" }
