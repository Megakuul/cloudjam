...
func (Application) CloudJamType() string { return "AWS::RefactorSpaces::Application" }
...
func (Environment) CloudJamType() string { return "AWS::RefactorSpaces::Environment" }
...
func (Route) CloudJamType() string { return "AWS::RefactorSpaces::Route" }
...
func (Service) CloudJamType() string { return "AWS::RefactorSpaces::Service" }
