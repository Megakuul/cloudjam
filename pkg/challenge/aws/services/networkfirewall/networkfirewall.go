...
func (Firewall) CloudJamType() string { return "AWS::NetworkFirewall::Firewall" }
...
func (FirewallPolicy) CloudJamType() string { return "AWS::NetworkFirewall::FirewallPolicy" }
...
func (LoggingConfiguration) CloudJamType() string {
...
func (RuleGroup) CloudJamType() string { return "AWS::NetworkFirewall::RuleGroup" }
...
func (TLSInspectionConfiguration) CloudJamType() string {
...
func (VpcEndpointAssociation) CloudJamType() string {
