...
func (CalculatedAttributeDefinition) CloudJamType() string {
...
func (Domain) CloudJamType() string { return "AWS::CustomerProfiles::Domain" }
...
func (DomainObjectType) CloudJamType() string { return "AWS::CustomerProfiles::DomainObjectType" }
...
func (EventStream) CloudJamType() string { return "AWS::CustomerProfiles::EventStream" }
...
func (EventTrigger) CloudJamType() string { return "AWS::CustomerProfiles::EventTrigger" }
...
func (Integration) CloudJamType() string { return "AWS::CustomerProfiles::Integration" }
...
func (ObjectType) CloudJamType() string { return "AWS::CustomerProfiles::ObjectType" }
...
func (Recommender) CloudJamType() string { return "AWS::CustomerProfiles::Recommender" }
...
func (SegmentDefinition) CloudJamType() string { return "AWS::CustomerProfiles::SegmentDefinition" }
