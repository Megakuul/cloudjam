...
func (IdentityPool) CloudJamType() string { return "AWS::Cognito::IdentityPool" }
...
func (IdentityPoolPrincipalTag) CloudJamType() string {
...
func (IdentityPoolRoleAttachment) CloudJamType() string {
...
func (LogDeliveryConfiguration) CloudJamType() string {
...
func (ManagedLoginBranding) CloudJamType() string { return "AWS::Cognito::ManagedLoginBranding" }
...
func (Terms) CloudJamType() string { return "AWS::Cognito::Terms" }
...
func (UserPool) CloudJamType() string { return "AWS::Cognito::UserPool" }
...
func (UserPoolClient) CloudJamType() string { return "AWS::Cognito::UserPoolClient" }
...
func (UserPoolDomain) CloudJamType() string { return "AWS::Cognito::UserPoolDomain" }
...
func (UserPoolGroup) CloudJamType() string { return "AWS::Cognito::UserPoolGroup" }
...
func (UserPoolIdentityProvider) CloudJamType() string {
...
func (UserPoolRegionalConfigurationAttachment) CloudJamType() string {
...
func (UserPoolReplica) CloudJamType() string { return "AWS::Cognito::UserPoolReplica" }
...
func (UserPoolResourceServer) CloudJamType() string { return "AWS::Cognito::UserPoolResourceServer" }
...
func (UserPoolRiskConfigurationAttachment) CloudJamType() string {
...
func (UserPoolUICustomizationAttachment) CloudJamType() string {
...
func (UserPoolUser) CloudJamType() string { return "AWS::Cognito::UserPoolUser" }
...
func (UserPoolUserToGroupAttachment) CloudJamType() string {
