...
func (Subscription) CloudJamType() string { return "AWS::SNS::Subscription" }
...
func (Topic) CloudJamType() string { return "AWS::SNS::Topic" }
...
func (TopicInlinePolicy) CloudJamType() string { return "AWS::SNS::TopicInlinePolicy" }
...
func (TopicPolicy) CloudJamType() string { return "AWS::SNS::TopicPolicy" }
