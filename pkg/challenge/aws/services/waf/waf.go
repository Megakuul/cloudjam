...
func (ByteMatchSet) CloudJamType() string { return "AWS::WAF::ByteMatchSet" }
...
func (IPSet) CloudJamType() string { return "AWS::WAF::IPSet" }
...
func (Rule) CloudJamType() string { return "AWS::WAF::Rule" }
...
func (SizeConstraintSet) CloudJamType() string { return "AWS::WAF::SizeConstraintSet" }
...
func (SqlInjectionMatchSet) CloudJamType() string { return "AWS::WAF::SqlInjectionMatchSet" }
...
func (WebACL) CloudJamType() string { return "AWS::WAF::WebACL" }
...
func (XssMatchSet) CloudJamType() string { return "AWS::WAF::XssMatchSet" }
