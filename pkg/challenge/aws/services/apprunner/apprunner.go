...
func (AutoScalingConfiguration) CloudJamType() string {
...
func (ObservabilityConfiguration) CloudJamType() string {
...
func (Service) CloudJamType() string { return "AWS::AppRunner::Service" }
...
func (VpcConnector) CloudJamType() string { return "AWS::AppRunner::VpcConnector" }
...
func (VpcIngressConnection) CloudJamType() string { return "AWS::AppRunner::VpcIngressConnection" }
