...
func (Keyspace) CloudJamType() string { return "AWS::Cassandra::Keyspace" }
...
func (Table) CloudJamType() string { return "AWS::Cassandra::Table" }
...
func (Type) CloudJamType() string { return "AWS::Cassandra::Type" }
