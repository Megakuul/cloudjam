...
func (DataSource) CloudJamType() string { return "AWS::Kendra::DataSource" }
...
func (Faq) CloudJamType() string { return "AWS::Kendra::Faq" }
...
func (Index) CloudJamType() string { return "AWS::Kendra::Index" }
