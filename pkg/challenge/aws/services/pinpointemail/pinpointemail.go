...
func (ConfigurationSet) CloudJamType() string { return "AWS::PinpointEmail::ConfigurationSet" }
...
func (DedicatedIpPool) CloudJamType() string { return "AWS::PinpointEmail::DedicatedIpPool" }
...
func (Identity) CloudJamType() string { return "AWS::PinpointEmail::Identity" }
