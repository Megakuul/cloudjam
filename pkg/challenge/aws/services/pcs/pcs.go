...
func (Cluster) CloudJamType() string { return "AWS::PCS::Cluster" }
...
func (ComputeNodeGroup) CloudJamType() string { return "AWS::PCS::ComputeNodeGroup" }
...
func (Queue) CloudJamType() string { return "AWS::PCS::Queue" }
