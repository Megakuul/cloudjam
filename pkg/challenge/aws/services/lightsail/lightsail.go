...
func (Alarm) CloudJamType() string { return "AWS::Lightsail::Alarm" }
...
func (Bucket) CloudJamType() string { return "AWS::Lightsail::Bucket" }
...
func (Certificate) CloudJamType() string { return "AWS::Lightsail::Certificate" }
...
func (Container) CloudJamType() string { return "AWS::Lightsail::Container" }
...
func (Database) CloudJamType() string { return "AWS::Lightsail::Database" }
...
func (DatabaseSnapshot) CloudJamType() string { return "AWS::Lightsail::DatabaseSnapshot" }
...
func (Disk) CloudJamType() string { return "AWS::Lightsail::Disk" }
...
func (DiskSnapshot) CloudJamType() string { return "AWS::Lightsail::DiskSnapshot" }
...
func (Distribution) CloudJamType() string { return "AWS::Lightsail::Distribution" }
...
func (Domain) CloudJamType() string { return "AWS::Lightsail::Domain" }
...
func (Instance) CloudJamType() string { return "AWS::Lightsail::Instance" }
...
func (InstanceSnapshot) CloudJamType() string { return "AWS::Lightsail::InstanceSnapshot" }
...
func (LoadBalancer) CloudJamType() string { return "AWS::Lightsail::LoadBalancer" }
...
func (LoadBalancerTlsCertificate) CloudJamType() string {
...
func (StaticIp) CloudJamType() string { return "AWS::Lightsail::StaticIp" }
