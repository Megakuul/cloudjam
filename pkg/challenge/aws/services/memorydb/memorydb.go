...
func (ACL) CloudJamType() string { return "AWS::MemoryDB::ACL" }
...
func (Cluster) CloudJamType() string { return "AWS::MemoryDB::Cluster" }
...
func (MultiRegionCluster) CloudJamType() string { return "AWS::MemoryDB::MultiRegionCluster" }
...
func (ParameterGroup) CloudJamType() string { return "AWS::MemoryDB::ParameterGroup" }
...
func (SubnetGroup) CloudJamType() string { return "AWS::MemoryDB::SubnetGroup" }
...
func (User) CloudJamType() string { return "AWS::MemoryDB::User" }
