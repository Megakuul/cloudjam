...
const file_v1_play_team_proto_rawDesc = "" +
	...
	"\busername\x18\x03 \x01(\tB\t\xbaH\x06r\x04\x10\x04\x18\x14R\busername\"\x91\x02\n" +
	"\x04Team\x12\x14\n" +
	"\x05scope\x18\x01 \x01(\tR\x05scope\x12!\n" +
	"\agame_id\x18\x02 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x06gameId\x12\x18\n" +
	"\x02id\x18\x03 \x01(\tB\b\xbaH\x05r\x03\xb0\x01\x01R\x02id\x12\x1d\n" +
	"\x04name\x18\x04 \x01(\tB\t\xbaH\x06r\x04\x10\x02\x18dR\x04name\x124\n" +
