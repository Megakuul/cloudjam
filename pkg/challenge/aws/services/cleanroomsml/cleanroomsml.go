...
func (ConfiguredModelAlgorithm) CloudJamType() string {
...
func (ConfiguredModelAlgorithmAssociation) CloudJamType() string {
...
func (TrainingDataset) CloudJamType() string { return "AWS::CleanRoomsML::TrainingDataset" }
