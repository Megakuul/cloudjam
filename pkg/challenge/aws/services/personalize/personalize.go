...
func (Dataset) CloudJamType() string { return "AWS::Personalize::Dataset" }
...
func (DatasetGroup) CloudJamType() string { return "AWS::Personalize::DatasetGroup" }
...
func (Schema) CloudJamType() string { return "AWS::Personalize::Schema" }
...
func (Solution) CloudJamType() string { return "AWS::Personalize::Solution" }
