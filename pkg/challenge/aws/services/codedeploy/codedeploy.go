...
func (Application) CloudJamType() string { return "AWS::CodeDeploy::Application" }
...
func (DeploymentConfig) CloudJamType() string { return "AWS::CodeDeploy::DeploymentConfig" }
...
func (DeploymentGroup) CloudJamType() string { return "AWS::CodeDeploy::DeploymentGroup" }
