...
func (AIAgent) CloudJamType() string { return "AWS::Wisdom::AIAgent" }
...
func (AIAgentVersion) CloudJamType() string { return "AWS::Wisdom::AIAgentVersion" }
...
func (AIGuardrail) CloudJamType() string { return "AWS::Wisdom::AIGuardrail" }
...
func (AIGuardrailVersion) CloudJamType() string { return "AWS::Wisdom::AIGuardrailVersion" }
...
func (AIPrompt) CloudJamType() string { return "AWS::Wisdom::AIPrompt" }
...
func (AIPromptVersion) CloudJamType() string { return "AWS::Wisdom::AIPromptVersion" }
...
func (Assistant) CloudJamType() string { return "AWS::Wisdom::Assistant" }
...
func (AssistantAssociation) CloudJamType() string { return "AWS::Wisdom::AssistantAssociation" }
...
func (KnowledgeBase) CloudJamType() string { return "AWS::Wisdom::KnowledgeBase" }
...
func (MessageTemplate) CloudJamType() string { return "AWS::Wisdom::MessageTemplate" }
...
func (MessageTemplateVersion) CloudJamType() string { return "AWS::Wisdom::MessageTemplateVersion" }
...
func (QuickResponse) CloudJamType() string { return "AWS::Wisdom::QuickResponse" }
