...
func (Accelerator) CloudJamType() string { return "AWS::GlobalAccelerator::Accelerator" }
...
func (CrossAccountAttachment) CloudJamType() string {
...
func (EndpointGroup) CloudJamType() string { return "AWS::GlobalAccelerator::EndpointGroup" }
...
func (Listener) CloudJamType() string { return "AWS::GlobalAccelerator::Listener" }
