...
func (ProfilePermission) CloudJamType() string { return "AWS::Signer::ProfilePermission" }
...
func (SigningProfile) CloudJamType() string { return "AWS::Signer::SigningProfile" }
