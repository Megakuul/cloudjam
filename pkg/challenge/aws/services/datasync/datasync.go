...
func (Agent) CloudJamType() string { return "AWS::DataSync::Agent" }
...
func (LocationAzureBlob) CloudJamType() string { return "AWS::DataSync::LocationAzureBlob" }
...
func (LocationEFS) CloudJamType() string { return "AWS::DataSync::LocationEFS" }
...
func (LocationFSxLustre) CloudJamType() string { return "AWS::DataSync::LocationFSxLustre" }
...
func (LocationFSxONTAP) CloudJamType() string { return "AWS::DataSync::LocationFSxONTAP" }
...
func (LocationFSxOpenZFS) CloudJamType() string { return "AWS::DataSync::LocationFSxOpenZFS" }
...
func (LocationFSxWindows) CloudJamType() string { return "AWS::DataSync::LocationFSxWindows" }
...
func (LocationHDFS) CloudJamType() string { return "AWS::DataSync::LocationHDFS" }
...
func (LocationNFS) CloudJamType() string { return "AWS::DataSync::LocationNFS" }
...
func (LocationObjectStorage) CloudJamType() string { return "AWS::DataSync::LocationObjectStorage" }
...
func (LocationS3) CloudJamType() string { return "AWS::DataSync::LocationS3" }
...
func (LocationSMB) CloudJamType() string { return "AWS::DataSync::LocationSMB" }
...
func (Task) CloudJamType() string { return "AWS::DataSync::Task" }
