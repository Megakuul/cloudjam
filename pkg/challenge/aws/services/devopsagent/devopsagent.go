...
func (AgentSpace) CloudJamType() string { return "AWS::DevOpsAgent::AgentSpace" }
...
func (Association) CloudJamType() string { return "AWS::DevOpsAgent::Association" }
...
func (PrivateConnection) CloudJamType() string { return "AWS::DevOpsAgent::PrivateConnection" }
...
func (Service) CloudJamType() string { return "AWS::DevOpsAgent::Service" }
