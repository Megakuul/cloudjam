...
func (Graph) CloudJamType() string { return "AWS::NeptuneGraph::Graph" }
...
func (GraphSnapshot) CloudJamType() string { return "AWS::NeptuneGraph::GraphSnapshot" }
...
func (PrivateGraphEndpoint) CloudJamType() string { return "AWS::NeptuneGraph::PrivateGraphEndpoint" }
