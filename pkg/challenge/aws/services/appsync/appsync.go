...
func (Api) CloudJamType() string { return "AWS::AppSync::Api" }
...
func (ApiCache) CloudJamType() string { return "AWS::AppSync::ApiCache" }
...
func (ApiKey) CloudJamType() string { return "AWS::AppSync::ApiKey" }
...
func (ChannelNamespace) CloudJamType() string { return "AWS::AppSync::ChannelNamespace" }
...
func (DataSource) CloudJamType() string { return "AWS::AppSync::DataSource" }
...
func (DomainName) CloudJamType() string { return "AWS::AppSync::DomainName" }
...
func (DomainNameApiAssociation) CloudJamType() string {
...
func (FunctionConfiguration) CloudJamType() string { return "AWS::AppSync::FunctionConfiguration" }
...
func (GraphQLApi) CloudJamType() string { return "AWS::AppSync::GraphQLApi" }
...
func (GraphQLSchema) CloudJamType() string { return "AWS::AppSync::GraphQLSchema" }
...
func (Resolver) CloudJamType() string { return "AWS::AppSync::Resolver" }
...
func (SourceApiAssociation) CloudJamType() string { return "AWS::AppSync::SourceApiAssociation" }
