...
import (
	...
	context "context"
	errors "errors"
	user "github.com/megakuul/zen/pkg/api/v1/user"
	http "net/http"
	strings "strings"
)
...
const (
	...
	UserServiceName = "v1.user.UserService"
)
...
const (
	...
	UserServiceCreateUserProcedure = "/v1.user.UserService/CreateUser"
	// UserServiceGetUserProcedure is the fully-qualified name of the UserService's GetUser RPC.
	UserServiceGetUserProcedure = "/v1.user.UserService/GetUser"
	// UserServiceUpdateUserProcedure is the fully-qualified name of the UserService's UpdateUser RPC.
	UserServiceUpdateUserProcedure = "/v1.user.UserService/UpdateUser"
	// UserServiceDeleteUserProcedure is the fully-qualified name of the UserService's DeleteUser RPC.
	UserServiceDeleteUserProcedure = "/v1.user.UserService/DeleteUser"
	// UserServiceListUsersProcedure is the fully-qualified name of the UserService's ListUsers RPC.
	UserServiceListUsersProcedure = "/v1.user.UserService/ListUsers"
)

// UserServiceClient is a client for the v1.user.UserService service.
...
// NewUserServiceClient constructs a client for the v1.user.UserService service. By default, it uses
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := user.File_v1_user_user_service_proto.Services().ByName("UserService").Methods()
...
// CreateUser calls v1.user.UserService.CreateUser.
...
// GetUser calls v1.user.UserService.GetUser.
...
// UpdateUser calls v1.user.UserService.UpdateUser.
...
// DeleteUser calls v1.user.UserService.DeleteUser.
...
// ListUsers calls v1.user.UserService.ListUsers.
...
// UserServiceHandler is an implementation of the v1.user.UserService service.
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/v1.user.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedUserServiceHandler) CreateUser(context.Context, *connect.Request[user.CreateUserRequest]) (*connect.Response[user.CreateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.user.UserService.CreateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) GetUser(context.Context, *connect.Request[user.GetUserRequest]) (*connect.Response[user.GetUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.user.UserService.GetUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) UpdateUser(context.Context, *connect.Request[user.UpdateUserRequest]) (*connect.Response[user.UpdateUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.user.UserService.UpdateUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[user.DeleteUserRequest]) (*connect.Response[user.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.user.UserService.DeleteUser is not implemented"))
}
...
func (UnimplementedUserServiceHandler) ListUsers(context.Context, *connect.Request[user.ListUsersRequest]) (*connect.Response[user.ListUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.user.UserService.ListUsers is not implemented"))
}
