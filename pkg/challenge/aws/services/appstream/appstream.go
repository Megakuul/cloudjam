...
func (AppBlock) CloudJamType() string { return "AWS::AppStream::AppBlock" }
...
func (AppBlockBuilder) CloudJamType() string { return "AWS::AppStream::AppBlockBuilder" }
...
func (Application) CloudJamType() string { return "AWS::AppStream::Application" }
...
func (ApplicationEntitlementAssociation) CloudJamType() string {
...
func (ApplicationFleetAssociation) CloudJamType() string {
...
func (DirectoryConfig) CloudJamType() string { return "AWS::AppStream::DirectoryConfig" }
...
func (Entitlement) CloudJamType() string { return "AWS::AppStream::Entitlement" }
...
func (Fleet) CloudJamType() string { return "AWS::AppStream::Fleet" }
...
func (ImageBuilder) CloudJamType() string { return "AWS::AppStream::ImageBuilder" }
...
func (Stack) CloudJamType() string { return "AWS::AppStream::Stack" }
...
func (StackFleetAssociation) CloudJamType() string { return "AWS::AppStream::StackFleetAssociation" }
...
func (StackUserAssociation) CloudJamType() string { return "AWS::AppStream::StackUserAssociation" }
...
func (User) CloudJamType() string { return "AWS::AppStream::User" }
