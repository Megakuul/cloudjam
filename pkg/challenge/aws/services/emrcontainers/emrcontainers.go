...
func (Endpoint) CloudJamType() string { return "AWS::EMRContainers::Endpoint" }
...
func (SecurityConfiguration) CloudJamType() string {
...
func (VirtualCluster) CloudJamType() string { return "AWS::EMRContainers::VirtualCluster" }
