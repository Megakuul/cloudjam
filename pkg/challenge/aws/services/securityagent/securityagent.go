...
func (AgentSpace) CloudJamType() string { return "AWS::SecurityAgent::AgentSpace" }
...
func (Application) CloudJamType() string { return "AWS::SecurityAgent::Application" }
...
func (Pentest) CloudJamType() string { return "AWS::SecurityAgent::Pentest" }
...
func (SecurityRequirementPack) CloudJamType() string {
...
func (TargetDomain) CloudJamType() string { return "AWS::SecurityAgent::TargetDomain" }
