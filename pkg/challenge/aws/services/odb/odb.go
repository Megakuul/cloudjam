...
func (CloudAutonomousVmCluster) CloudJamType() string { return "AWS::ODB::CloudAutonomousVmCluster" }
...
func (CloudExadataInfrastructure) CloudJamType() string {
...
func (CloudVmCluster) CloudJamType() string { return "AWS::ODB::CloudVmCluster" }
...
func (OdbNetwork) CloudJamType() string { return "AWS::ODB::OdbNetwork" }
...
func (OdbPeeringConnection) CloudJamType() string { return "AWS::ODB::OdbPeeringConnection" }
