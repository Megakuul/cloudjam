...
func (ScalableTarget) CloudJamType() string { return "AWS::ApplicationAutoScaling::ScalableTarget" }
...
func (ScalingPolicy) CloudJamType() string { return "AWS::ApplicationAutoScaling::ScalingPolicy" }
