...
func (BillingGroup) CloudJamType() string { return "AWS::BillingConductor::BillingGroup" }
...
func (CustomLineItem) CloudJamType() string { return "AWS::BillingConductor::CustomLineItem" }
...
func (PricingPlan) CloudJamType() string { return "AWS::BillingConductor::PricingPlan" }
...
func (PricingRule) CloudJamType() string { return "AWS::BillingConductor::PricingRule" }
