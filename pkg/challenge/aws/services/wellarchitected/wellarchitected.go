...
func (Lens) CloudJamType() string { return "AWS::WellArchitected::Lens" }
...
func (Profile) CloudJamType() string { return "AWS::WellArchitected::Profile" }
...
func (ReviewTemplate) CloudJamType() string { return "AWS::WellArchitected::ReviewTemplate" }
