...
func (AggregatorV2) CloudJamType() string { return "AWS::SecurityHub::AggregatorV2" }
...
func (AutomationRule) CloudJamType() string { return "AWS::SecurityHub::AutomationRule" }
...
func (AutomationRuleV2) CloudJamType() string { return "AWS::SecurityHub::AutomationRuleV2" }
...
func (ConfigurationPolicy) CloudJamType() string { return "AWS::SecurityHub::ConfigurationPolicy" }
...
func (Connector) CloudJamType() string { return "AWS::SecurityHub::Connector" }
...
func (ConnectorV2) CloudJamType() string { return "AWS::SecurityHub::ConnectorV2" }
...
func (DelegatedAdmin) CloudJamType() string { return "AWS::SecurityHub::DelegatedAdmin" }
...
func (FindingAggregator) CloudJamType() string { return "AWS::SecurityHub::FindingAggregator" }
...
func (Hub) CloudJamType() string { return "AWS::SecurityHub::Hub" }
...
func (HubV2) CloudJamType() string { return "AWS::SecurityHub::HubV2" }
...
func (Insight) CloudJamType() string { return "AWS::SecurityHub::Insight" }
...
func (OrganizationConfiguration) CloudJamType() string {
...
func (PolicyAssociation) CloudJamType() string { return "AWS::SecurityHub::PolicyAssociation" }
...
func (ProductSubscription) CloudJamType() string { return "AWS::SecurityHub::ProductSubscription" }
...
func (SecurityControl) CloudJamType() string { return "AWS::SecurityHub::SecurityControl" }
...
func (Standard) CloudJamType() string { return "AWS::SecurityHub::Standard" }
