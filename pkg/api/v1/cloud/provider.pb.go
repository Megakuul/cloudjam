...
const file_v1_cloud_provider_proto_rawDesc = "" +
	"\n" +
	"\x17v1/cloud/provider.proto\x12\bv1.cloud\x1a\x1bbuf/validate/validate.proto\"\x9b\x02\n" +
	"\bProvider\x12\x14\n" +
	...
	"\x04name\x18\x04 \x01(\tB\t\xbaH\x06r\x04\x10\x03\x18\x14R\x04name\x12+\n" +
	"\vdescription\x18\x05 \x01(\tB\t\xbaH\x06r\x04\x10\x00\x182R\vdescription\x12\x1f\n" +
	"\x05email\x18\x06 \x01(\tB\t\xbaH\x06r\x04\x18\x1b`\x01R\x05email\x12\x18\n" +
