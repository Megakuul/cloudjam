...
func (Cluster) CloudJamType() string { return "AWS::Route53RecoveryControl::Cluster" }
...
func (ControlPanel) CloudJamType() string { return "AWS::Route53RecoveryControl::ControlPanel" }
...
func (RoutingControl) CloudJamType() string { return "AWS::Route53RecoveryControl::RoutingControl" }
...
func (SafetyRule) CloudJamType() string { return "AWS::Route53RecoveryControl::SafetyRule" }
