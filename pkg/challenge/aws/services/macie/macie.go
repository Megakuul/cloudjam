...
func (AllowList) CloudJamType() string { return "AWS::Macie::AllowList" }
...
func (CustomDataIdentifier) CloudJamType() string { return "AWS::Macie::CustomDataIdentifier" }
...
func (FindingsFilter) CloudJamType() string { return "AWS::Macie::FindingsFilter" }
...
func (Session) CloudJamType() string { return "AWS::Macie::Session" }
