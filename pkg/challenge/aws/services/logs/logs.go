...
func (AccountPolicy) CloudJamType() string { return "AWS::Logs::AccountPolicy" }
...
func (Delivery) CloudJamType() string { return "AWS::Logs::Delivery" }
...
func (DeliveryDestination) CloudJamType() string { return "AWS::Logs::DeliveryDestination" }
...
func (DeliverySource) CloudJamType() string { return "AWS::Logs::DeliverySource" }
...
func (Destination) CloudJamType() string { return "AWS::Logs::Destination" }
...
func (Integration) CloudJamType() string { return "AWS::Logs::Integration" }
...
func (LogAnomalyDetector) CloudJamType() string { return "AWS::Logs::LogAnomalyDetector" }
...
func (LogGroup) CloudJamType() string { return "AWS::Logs::LogGroup" }
...
func (LogStream) CloudJamType() string { return "AWS::Logs::LogStream" }
...
func (MetricFilter) CloudJamType() string { return "AWS::Logs::MetricFilter" }
...
func (QueryDefinition) CloudJamType() string { return "AWS::Logs::QueryDefinition" }
...
func (ResourcePolicy) CloudJamType() string { return "AWS::Logs::ResourcePolicy" }
...
func (ScheduledQuery) CloudJamType() string { return "AWS::Logs::ScheduledQuery" }
...
func (SubscriptionFilter) CloudJamType() string { return "AWS::Logs::SubscriptionFilter" }
...
func (Transformer) CloudJamType() string { return "AWS::Logs::Transformer" }
