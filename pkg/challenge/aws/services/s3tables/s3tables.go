...
func (Namespace) CloudJamType() string { return "AWS::S3Tables::Namespace" }
...
func (Table) CloudJamType() string { return "AWS::S3Tables::Table" }
...
func (TableBucket) CloudJamType() string { return "AWS::S3Tables::TableBucket" }
...
func (TableBucketPolicy) CloudJamType() string { return "AWS::S3Tables::TableBucketPolicy" }
...
func (TablePolicy) CloudJamType() string { return "AWS::S3Tables::TablePolicy" }
