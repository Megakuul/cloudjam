...
func (NotificationChannel) CloudJamType() string { return "AWS::FMS::NotificationChannel" }
...
func (Policy) CloudJamType() string { return "AWS::FMS::Policy" }
...
func (ResourceSet) CloudJamType() string { return "AWS::FMS::ResourceSet" }
