...
func (Volume) CloudJamType() string { return "AWS::WorkspacesInstances::Volume" }
...
func (VolumeAssociation) CloudJamType() string { return "AWS::WorkspacesInstances::VolumeAssociation" }
...
func (WorkspaceInstance) CloudJamType() string { return "AWS::WorkspacesInstances::WorkspaceInstance" }
