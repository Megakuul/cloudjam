...
func (FirewallDomainList) CloudJamType() string { return "AWS::Route53Resolver::FirewallDomainList" }
...
func (FirewallRuleGroup) CloudJamType() string { return "AWS::Route53Resolver::FirewallRuleGroup" }
...
func (FirewallRuleGroupAssociation) CloudJamType() string {
...
func (OutpostResolver) CloudJamType() string { return "AWS::Route53Resolver::OutpostResolver" }
...
func (ResolverConfig) CloudJamType() string { return "AWS::Route53Resolver::ResolverConfig" }
...
func (ResolverDNSSECConfig) CloudJamType() string {
...
func (ResolverEndpoint) CloudJamType() string { return "AWS::Route53Resolver::ResolverEndpoint" }
...
func (ResolverQueryLoggingConfig) CloudJamType() string {
...
func (ResolverQueryLoggingConfigAssociation) CloudJamType() string {
...
func (ResolverRule) CloudJamType() string { return "AWS::Route53Resolver::ResolverRule" }
...
func (ResolverRuleAssociation) CloudJamType() string {
