...
func (AlarmModel) CloudJamType() string { return "AWS::IoTEvents::AlarmModel" }
...
func (DetectorModel) CloudJamType() string { return "AWS::IoTEvents::DetectorModel" }
...
func (Input) CloudJamType() string { return "AWS::IoTEvents::Input" }
