...
func (AccessGrant) CloudJamType() string { return "AWS::S3::AccessGrant" }
...
func (AccessGrantsInstance) CloudJamType() string { return "AWS::S3::AccessGrantsInstance" }
...
func (AccessGrantsLocation) CloudJamType() string { return "AWS::S3::AccessGrantsLocation" }
...
func (AccessPoint) CloudJamType() string { return "AWS::S3::AccessPoint" }
...
func (Bucket) CloudJamType() string { return "AWS::S3::Bucket" }
...
func (BucketPolicy) CloudJamType() string { return "AWS::S3::BucketPolicy" }
...
func (MultiRegionAccessPoint) CloudJamType() string { return "AWS::S3::MultiRegionAccessPoint" }
...
func (MultiRegionAccessPointPolicy) CloudJamType() string {
...
func (StorageLens) CloudJamType() string { return "AWS::S3::StorageLens" }
...
func (StorageLensGroup) CloudJamType() string { return "AWS::S3::StorageLensGroup" }
