...
func (AnomalyMonitor) CloudJamType() string { return "AWS::CE::AnomalyMonitor" }
...
func (AnomalySubscription) CloudJamType() string { return "AWS::CE::AnomalySubscription" }
...
func (CostCategory) CloudJamType() string { return "AWS::CE::CostCategory" }
