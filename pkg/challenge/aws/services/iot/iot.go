...
func (AccountAuditConfiguration) CloudJamType() string { return "AWS::IoT::AccountAuditConfiguration" }
...
func (Authorizer) CloudJamType() string { return "AWS::IoT::Authorizer" }
...
func (BillingGroup) CloudJamType() string { return "AWS::IoT::BillingGroup" }
...
func (CACertificate) CloudJamType() string { return "AWS::IoT::CACertificate" }
...
func (Certificate) CloudJamType() string { return "AWS::IoT::Certificate" }
...
func (CertificateProvider) CloudJamType() string { return "AWS::IoT::CertificateProvider" }
...
func (Command) CloudJamType() string { return "AWS::IoT::Command" }
...
func (CustomMetric) CloudJamType() string { return "AWS::IoT::CustomMetric" }
...
func (Dimension) CloudJamType() string { return "AWS::IoT::Dimension" }
...
func (DomainConfiguration) CloudJamType() string { return "AWS::IoT::DomainConfiguration" }
...
func (EncryptionConfiguration) CloudJamType() string { return "AWS::IoT::EncryptionConfiguration" }
...
func (FleetMetric) CloudJamType() string { return "AWS::IoT::FleetMetric" }
...
func (JobTemplate) CloudJamType() string { return "AWS::IoT::JobTemplate" }
...
func (Logging) CloudJamType() string { return "AWS::IoT::Logging" }
...
func (MitigationAction) CloudJamType() string { return "AWS::IoT::MitigationAction" }
...
func (Policy) CloudJamType() string { return "AWS::IoT::Policy" }
...
func (PolicyPrincipalAttachment) CloudJamType() string { return "AWS::IoT::PolicyPrincipalAttachment" }
...
func (ProvisioningTemplate) CloudJamType() string { return "AWS::IoT::ProvisioningTemplate" }
...
func (ResourceSpecificLogging) CloudJamType() string { return "AWS::IoT::ResourceSpecificLogging" }
...
func (RoleAlias) CloudJamType() string { return "AWS::IoT::RoleAlias" }
...
func (ScheduledAudit) CloudJamType() string { return "AWS::IoT::ScheduledAudit" }
...
func (SecurityProfile) CloudJamType() string { return "AWS::IoT::SecurityProfile" }
...
func (SoftwarePackage) CloudJamType() string { return "AWS::IoT::SoftwarePackage" }
...
func (SoftwarePackageVersion) CloudJamType() string { return "AWS::IoT::SoftwarePackageVersion" }
...
func (Thing) CloudJamType() string { return "AWS::IoT::Thing" }
...
func (ThingGroup) CloudJamType() string { return "AWS::IoT::ThingGroup" }
...
func (ThingPrincipalAttachment) CloudJamType() string { return "AWS::IoT::ThingPrincipalAttachment" }
...
func (ThingType) CloudJamType() string { return "AWS::IoT::ThingType" }
...
func (TopicRule) CloudJamType() string { return "AWS::IoT::TopicRule" }
...
func (TopicRuleDestination) CloudJamType() string { return "AWS::IoT::TopicRuleDestination" }
