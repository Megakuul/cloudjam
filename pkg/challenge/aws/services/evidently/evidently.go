...
func (Experiment) CloudJamType() string { return "AWS::Evidently::Experiment" }
...
func (Feature) CloudJamType() string { return "AWS::Evidently::Feature" }
...
func (Launch) CloudJamType() string { return "AWS::Evidently::Launch" }
...
func (Project) CloudJamType() string { return "AWS::Evidently::Project" }
...
func (Segment) CloudJamType() string { return "AWS::Evidently::Segment" }
